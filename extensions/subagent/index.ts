/**
 * Subagent Tool — Standalone Extension
 *
 * Adapted from Pi's example extension for use as an installable extension.
 *
	...
	pi.registerTool({
		...
		async execute(_toolCallId, params, signal, onUpdate, ctx) {
			...
			if (params.tasks && params.tasks.length > 0) {
				...
				const allResults: SingleResult[] = new Array(params.tasks.length) as SingleResult[];
